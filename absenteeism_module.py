...
class absenteeism_model():
        ...
        def load_and_clean_data(self, data_file):
            ...
            column_names = ['Date', 'Transportation Expense', 'Distance to Work', 'Age',
                           'Daily Work Load', 'Body Mass Index', 'Education', 'Children',
            ...
            column_names_reordered = ['Reason 1', 'Reason 2', 'Reason 3', 'Reason 4', 'Date', 'Transportation Expense', 
                                      'Distance to Work', 'Age', 'Daily Work Load', 'Body Mass Index', 'Education', 
            ...
            df = df.drop(['Day of the week','Daily Work Load','Distance to Work'],axis=1)
